...
public final class Lexer implements TokenSource {
    ...
    private Token token(
            TokenType type, String semanticLexeme, String text, String leadingTrivia, SourcePosition start) {
        return new Token(type, semanticLexeme, text, leadingTrivia, new SourceSpan(start, lastConsumed));
    }
