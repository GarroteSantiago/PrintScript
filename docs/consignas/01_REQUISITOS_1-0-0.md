...
- [ ] Las variables y literales de tipo "number" deben soportar operaciones aritmeticas binarias:
  ...
  - [ ] multiplicacion
  - [ ] division
- [X] "number" incluye enteros y decimales
- [X] concatenacion de variables y literales de tipo "string"
  - [X] con el simbolo +
  - [X] Esto incluye la concatenacion de "number" y "string"
- [X] "println(text: string)" -> una expresion que imprime text y luego un salto de linea
...
- [ ] Argumentos
  - [ ] Comandos
    ...
    - [ ] Analyzing
  - [ ] Archivo fuente
  - [X] Version del archivo a interpretar (Unicamente 1.0 por ahora)
